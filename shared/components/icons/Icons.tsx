...
export const CogIcon: React.FC<{ className?: string }> = ({ className = "h-5 w-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.007 1.11-1.212l2.29-.815a1.125 1.125 0 011.32 1.32l-.815 2.29a1.125 1.125 0 001.212 1.11l.542-.09c.542-.09.995.344 1.139.886l.27 1.051a1.125 1.125 0 01-1.242 1.384l-1.052-.27a1.125 1.125 0 00-1.384 1.242l.27 1.051c.143.542-.344.995-.886 1.139l-.542.09a1.125 1.125 0 00-1.11 1.212l.815 2.29a1.125 1.125 0 01-1.32 1.32l-2.29-.815a1.125 1.125 0 00-1.212 1.11l-.09.542c-.09.542-.56.995-1.139.886l-1.051-.27a1.125 1.125 0 01-1.384-1.242l.27-1.052a1.125 1.125 0 00-1.242-1.384l-1.051.27c-.542.143-.995-.344-.886-1.139l.09-.542a1.125 1.125 0 00-1.212-1.11l-2.29.815a1.125 1.125 0 01-1.32-1.32l.815-2.29a1.125 1.125 0 00-1.11-1.212l-.542.09c-.542.09-.886-.344-.886-1.139l.27-1.051a1.125 1.125 0 011.384-1.242l1.052.27a1.125 1.125 0 001.384-1.242l-.27-1.051c-.143-.542.344-.995.886-.886l.542.09z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);

export const DeviceTabletIcon: React.FC<{ className?: string }> = ({ className = "h-8 w-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
    </svg>
);

export const BoltIcon: React.FC<{ className?: string }> = ({ className = "h-8 w-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
    </svg>
);

export const GlobeAltIcon: React.FC<{ className?: string }> = ({ className = "h-8 w-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const PresentationChartLineIcon: React.FC<{ className?: string }> = ({ className = "h-8 w-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const CheckIcon: React.FC<{ className?: string }> = ({ className = "h-6 w-5 flex-none text-accent" }) => (
