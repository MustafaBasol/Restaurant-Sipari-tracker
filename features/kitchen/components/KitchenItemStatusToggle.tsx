...
const KitchenItemStatusToggle: React.FC<KitchenItemStatusToggleProps> = ({ status, onChange, disabled }) => {
    const { t } = useLanguage();

    const baseClasses = 'px-4 py-2 text-sm font-semibold rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent/50 disabled:opacity-50 disabled:cursor-not-allowed';
