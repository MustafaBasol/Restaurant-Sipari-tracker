...
const TenantDetailModal: React.FC<TenantDetailModalProps> = ({ tenant, users, onClose, onSubscriptionChange }) => {
    const { t } = useLanguage();
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div className="space-y-2 text-sm">
                        <InfoRow label={t('superAdmin.registeredOn')} value={formatDateTime(tenant.createdAt, 'UTC', { dateStyle: 'long' })} />
                    ...
                    <div className="mt-6">
                        <h4 className="font-semibold mb-2">{t('superAdmin.tenantDetails.subscriptionManagement')}</h4>
                        <Select 
                            value={tenant.subscriptionStatus}
                            onChange={(e) => onSubscriptionChange(tenant.id, e.target.value as SubscriptionStatus)}
