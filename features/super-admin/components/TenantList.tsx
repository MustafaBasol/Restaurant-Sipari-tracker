...
const TenantList: React.FC = () => {
  ...
  const SortableHeader: React.FC<{ sortKey: SortKey; labelKey: string }> = ({
    sortKey: key,
    labelKey,
  }) => (
    <th
              ...
              <TableRow key={tenant.id}>
                ...
                <TableCell>
                  <Badge variant={statusVariantMap[tenant.subscriptionStatus]}>
                    {t(
                      `statuses.${tenant.subscriptionStatus === SubscriptionStatus.CANCELED ? 'CANCELED_SUB' : tenant.subscriptionStatus}`,
                    )}
                  </Badge>
                </TableCell>
                <TableCell>
