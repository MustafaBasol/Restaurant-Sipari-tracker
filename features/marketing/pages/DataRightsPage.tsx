        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold tracking-tight text-text-primary sm:text-5xl">
              {t('marketing.legal.dataRightsTitle')}
            </h1>
          ...
          <div className="bg-card-bg p-8 sm:p-12 rounded-2xl shadow-subtle border border-border-color">
            <LegalSection
              titleKey="marketing.legal.r1_title"
              contentKey="marketing.legal.r1_content"
            />
            <LegalSection
              titleKey="marketing.legal.r2_title"
              contentKey="marketing.legal.r2_content"
            />
            <LegalSection
              titleKey="marketing.legal.r3_title"
              contentKey="marketing.legal.r3_content"
            />
            <LegalSection
              titleKey="marketing.legal.r4_title"
              contentKey="marketing.legal.r4_content"
            />
          </div>
        </div>
      </div>
