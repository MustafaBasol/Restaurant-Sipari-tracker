...
const HowItWorksSection: React.FC = () => {
    ...
    const steps = [
        { nameKey: 'marketing.howItWorks.step1.title', descriptionKey: 'marketing.howItWorks.step1.description' },
        { nameKey: 'marketing.howItWorks.step2.title', descriptionKey: 'marketing.howItWorks.step2.description' },
        { nameKey: 'marketing.howItWorks.step3.title', descriptionKey: 'marketing.howItWorks.step3.description' },
    ];
