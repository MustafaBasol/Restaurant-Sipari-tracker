    ...
    >
      <div className="bg-card-bg rounded-xl shadow-2xl p-4">
        ...
        <div className="grid grid-cols-3 gap-2 p-4">
          <div className="aspect-square bg-status-free/20 rounded-lg flex items-center justify-center font-bold text-status-free">
            T1
          </div>
          <div className="aspect-square bg-status-occupied/20 rounded-lg flex items-center justify-center font-bold text-status-occupied">
            T2
          </div>
          <div className="aspect-square bg-status-free/20 rounded-lg flex items-center justify-center font-bold text-status-free">
            T3
